# Adapted from https://git.sr.ht/~oscarcp/ghostfiles/tree/master/item/sway_wm/config.d
...
#echo "$audio_active $audio_volume% | ⌨ $language | $battery_pluggedin $battery_charge | $date_and_week 🕘 $current_time"
echo "Volume $audio_volume% | ⌨ $language | $battery_pluggedin $battery_charge | $date_and_week | $current_time"
